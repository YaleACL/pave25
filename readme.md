...
title = {tagline = "The", title = "2nd Yale Symposium", subtitles = ["on Privacy, Accountability, Verification and Economics of Blockchain Systems"]} # this contains the header's tagline, title, and list of subtitles, which are displayed in order
